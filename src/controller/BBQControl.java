...
public class BBQControl {
    ...
    public void addAccompanimentToList(Accompaniment accompaniment) {
        boolean alreadyThere = false;
        if (builder.getAccompanimentsList() != null) {
    ...
    public Barbercue createBarbecueEvent(Customer customer, Calendar date, boolean edit) {
        ...
        try {
            ...
            System.out.println(" fuck fuck " + ex.getLocalizedMessage());
            Logger.getLogger(BBQControl.class.getName()).log(Level.SEVERE, null, ex);
        }
