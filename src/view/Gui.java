...
public class Gui extends javax.swing.JFrame {
    ...
    public void showMonth() {
        ...
        int height = Toolkit.getDefaultToolkit().getScreenSize().height - jframe.getHeight();
        int widht = Toolkit.getDefaultToolkit().getScreenSize().width - jframe.getWidth();
    ...
    private void initComponents() {
        ...
        jMenuItem2.setText("Måned/Uge Kalender");
        ...
        jMenuItem4.setText("Rediger Info For Massage Typer");
