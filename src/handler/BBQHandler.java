...
public class BBQHandler {
    ...
    public void saveBarbecueToDB(Event event, boolean edit) throws SQLException {
        ResultSet rs;
        int id = 0;
        System.out.println(" boolean = " + edit);
        ...
        if (bar.getAccompanimentsList() != null) {
